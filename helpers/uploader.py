...
async def UploadVideo(bot: Client, cb: CallbackQuery, file_path: str, width, height, duration, video_thumbnail, file_size, default_thumb: Thumbnail = video_thumbnail):
    try:
        sent_ = None
